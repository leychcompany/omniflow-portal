...
interface TrainingCourseActionsProps {
  courseTitle: string
  onEdit: () => void
  onDelete: () => void
}
...
/**
 * Anchored action menu (no portal) — avoids Radix dropdown “flying in” from the viewport edge.
 */
export function TrainingCourseActions({ courseTitle, onEdit, onDelete }: TrainingCourseActionsProps) {
    ...
    <div className="relative shrink-0" ref={rootRef}>
      ...
      {open && (
        <div
          role="menu"
          className={cn(
            'absolute right-0 top-full z-50 mt-1.5 min-w-[11rem] overflow-hidden rounded-xl',
