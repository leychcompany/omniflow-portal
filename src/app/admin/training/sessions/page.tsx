  ...
  return (
    <div className="space-y-6 pb-20 md:pb-0 max-w-5xl">
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-[#141414] overflow-x-auto">
          <table className="w-full min-w-[52rem] text-sm">
            <thead>
              <tr className="border-b border-zinc-200 dark:border-white/[0.06] bg-zinc-50/95 dark:bg-white/[0.04]">
                ...
                <th className="text-left py-3 px-4 font-medium text-zinc-600 dark:text-zinc-400 hidden md:table-cell whitespace-nowrap">
                  Starts
                </th>
              ...
              {sessions.map((s) => {
                ...
                return (
                  <tr key={s.id} className="border-b border-zinc-100 dark:border-white/[0.04] last:border-0">
                    ...
                    <td className="py-3 px-4 text-zinc-600 dark:text-zinc-400 hidden md:table-cell whitespace-nowrap align-top">
